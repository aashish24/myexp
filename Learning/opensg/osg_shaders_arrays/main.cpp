...
"       vec4 lightDir         = light_positions[i];\n "
...
int main(int argc, char **argv)
{
    ...
    MFReal32 lights_on_1;
    lights_on_1.push_back( 1 );
    lights_on_1.push_back( 1 );
    lights_on_1.push_back( 1 );
    lights_on_1.push_back( 0 );
    lights_on_1.push_back( 0 );
    lights_on_1.push_back( 0 );

    MFReal32 lights_on_2;
    lights_on_2.push_back( 0 );
    lights_on_2.push_back( 0 );
    lights_on_2.push_back( 0 );
    lights_on_2.push_back( 1 );
    lights_on_2.push_back( 1 );
    lights_on_2.push_back( 1 );
    ...
    _shl->setUniformParameter( "lights_on", lights_on_1 );
    ...
    _shl_2->setUniformParameter( "lights_on", lights_on_2 );
