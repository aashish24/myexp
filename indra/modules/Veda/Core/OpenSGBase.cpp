...
#include "Veda/Core/OpenSGBase.h"
...
namespace Veda
{
  namespace Core
  {
		...
		void OpenSGBase::initScene()
		{
			vprDEBUG_OutputGuard(vprDBG_ALL, vprDBG_CRITICAL_LVL,
                        "OpenSGBase::initScene() called.\n",
                        "OpenSGBase::initScene() exiting.\n");
         ...
         << "[OpenSGBase::initScene()] No model specified; creating torus."
         << std::endl << vprDEBUG_FLUSH;
			...
			{
				vprDEBUG(vprDBG_ALL, vprDBG_CRITICAL_LVL)
         << "[OpenSGBase::initScene()] Loading '" << mFileToLoad << "' ..."
         << std::endl << vprDEBUG_FLUSH;
				mModelRoot =
