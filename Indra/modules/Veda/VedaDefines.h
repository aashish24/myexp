...
#ifndef __VEDA_CORE_VEDADEFINES_H__
#define __VEDA_CORE_VEDADEFINES_H__

//@Todo: Find a better way to determine vrjuggler version. 

// If we are using OpenSceneGraph
#define HAVE_OSG                1
